...
describe('Service Tests', () => {
  describe('SpotifyAccount Service', () => {
    ...
    let elemDefault: ISpotifyAccount;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(SpotifyAccountService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new SpotifyAccount(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a SpotifyAccount', () => {
        ...
        service.create(new SpotifyAccount()).subscribe(resp => (expectedResult = resp.body));
